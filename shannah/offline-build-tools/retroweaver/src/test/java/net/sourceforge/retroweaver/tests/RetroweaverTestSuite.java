...
public class RetroweaverTestSuite extends TestSuite {
	...
	public RetroweaverTestSuite() {
		...
		addTestSuite(CharacterTest.class);
		addTestSuite(WriterTest.class);
		addTestSuite(MathTest.class);
		addTestSuite(JRubyTest.class);
		addTestSuite(CloseableTest.class);
		...
		if (v > 3) {
			...
			addTestSuite(ConstructorTest.class);
			addTestSuite(FieldTest.class);
			addTestSuite(MethodTest.class);
		}
