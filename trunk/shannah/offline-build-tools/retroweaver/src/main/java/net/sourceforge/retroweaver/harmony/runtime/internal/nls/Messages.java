...
package net.sourceforge.retroweaver.harmony.runtime.internal.nls;
...
public class Messages {
    ...
    static public ResourceBundle setLocale(final Locale locale,
        ...
        try {
        	// FIXME AccessController problem with jdk 1.3
    ...
    static {
        ...
        try {
            bundle = setLocale(Locale.getDefault(),
            		"net.sourceforge.retroweaver.harmony.runtime.internal.nls.messages"); //$NON-NLS-1$
